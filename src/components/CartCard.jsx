...
const CartCard = () => {
  ...
  return (
    <div>
      ...
      {!isOpen && (
        <div className='absolute right-5 top-32 bg-white rounded-full p-2 shadow-lg cursor-pointer z-50'>
      ...
      {/* Cart Modal */}
      {isOpen && (
        <div className='absolute right-5 top-32 w-96 bg-white shadow-lg rounded-md p-4 z-50'>
